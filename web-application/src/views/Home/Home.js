						...
						>
							<Col xs={24} md={8}>
								...
								>
									...
									<Paragraph style={{ fontSize: 16, textAlign: "center" }}>
										AutoPacker will automatically build your projects and modules using an easy-to-use wizard
										for finding out your requirements.
									</Paragraph>
								</div>
							</Col>
							<Col xs={24} md={8}>
								...
								>
									...
									<Paragraph style={{ fontSize: 16, textAlign: "center" }}>
										AutoPacker will use the servers you provide to deploy your uploaded projects
										automatically. This is especially useful for students who have virtual machines provided
										by their schools.
									</Paragraph>
								</div>
							</Col>
							<Col xs={24} md={8}>
								...
								>
									...
									<Paragraph style={{ fontSize: 16, textAlign: "center" }}>
										By using virtualization technology, AutoPacker can bundle your software into operating
										system independent packages that can run on any host.
									</Paragraph>
								</div>
							</Col>
						</Row>
					...
					<Col xs={20}>
						<Row type="flex" justify="center">
							<Col style={{ textAlign: "center" }} xs={24}>
								...
								>
									AutoPacker is a bachelor project created with universities and students in mind. Both
									universities and students can use the platform for storing, hosting, and sharing bachelor
									projects, lectures, tools and other software using a modern platform with multiple wizards to
									help.
								</Paragraph>
								<Carousel
									autoplay
