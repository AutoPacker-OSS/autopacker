...
import { FileAddOutlined, BuildOutlined, UserOutlined, PlayCircleOutlined } from '@ant-design/icons';
      ...
      <Content
        ...
        {selectedChoice === null ? (
          <Row className="module-wrapper" type="flex" justify="center" gutter={[16]}>
            <Col span={5}>
              <Card style={{ margin: '0 auto' }} className="module-card" onClick={() => setSelectedChoice(1)}>
            ...
            <Col span={5}>
              <Card style={{ margin: '0 auto' }} className="module-card" onClick={() => setSelectedChoice(4)}>
                <Row type="flex" justify="center" align="middle">
                  <div style={{ textAlign: 'center' }}>
                    <Col xs={24}>
