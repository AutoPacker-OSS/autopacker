  ...
  return (
    <div style={{ width: '100%' }}>
      ...
      <Paragraph style={{ maxWidth: 500, marginLeft: 'auto', marginRight: 'auto' }}>
        If you already have a docker-compose.yml file that describes your project architecture, you can simply upload
        that file as a "module" (assuming the docker image(s) in the file are available on docker hub). Then you can
        click upload on any of the servers you have and it will build the system out of your specification.{' '}
