  ...
  return (
    <div style={{ width: '100%' }}>
      <PageHeader
        ...
        breadcrumb={{ routes }}>
        <Paragraph>
          Form to submit a project to the organization, when you submit the organization takes over the ownership of the
          project
        </Paragraph>
      </PageHeader>
      ...
      <Content
        ...
        {redirect ? <Navigate to={'/organization/submissions/' + organizationName} /> : <div />}
        ...
        <Form {...formItemLayout}>
          ...
          <Form.Item
            ...
            <div>
              ...
              <Text>{selectedProject !== null ? ' ' + selectedProject.name : <div />}</Text>
            </div>
          </Form.Item>
          ...
          <div style={{ width: '100%', textAlign: 'center' }}>
            <Button disabled={selectedProject === null} type="primary" onClick={(e) => handleSubmit(e)}>
              Submit Project
            </Button>
          </div>
        </Form>
