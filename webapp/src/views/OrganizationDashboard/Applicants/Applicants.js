      ...
      <Content
        ...
        <div
          ...
          <Collapse>
            {applicants.length > 0
              ? applicants.map((applicant) => (
                  <Panel header={applicant.user.username} key={applicant.id} extra={applicant.created}>
                    <Row gutter={[24, 0]}>
                      <Col xs={24} md={4}>
                        <img
                      ...
                      <Col xs={24} md={20}>
                        <Descriptions title="Applicant Details">
                          <Descriptions.Item label="Name">{applicant.user.name}</Descriptions.Item>
                          <Descriptions.Item label="Role">{applicant.role}</Descriptions.Item>
                        ...
                        <div style={{ float: 'right', padding: 10 }}>
                          <Button
                            ...
                            type="danger"
                            onClick={() => openDeclineModal(applicant.user.username, applicant.user.name)}>
                            Decline Request
                          </Button>
                          <Button
                            type="primary"
                            onClick={() =>
                              openAcceptModal(applicant.user.username, applicant.user.name, applicant.role)
                            }>
                            Accept Request
                          </Button>
                        </div>
          ...
          <Modal
            ...
            <p>
              By declining the request, the applicant will be notified. You can add a comment which will be sent with
              the email. Can include a reason why the application is declined.
            </p>
            <TextArea
              placeholder="Comment..."
              allowClear
