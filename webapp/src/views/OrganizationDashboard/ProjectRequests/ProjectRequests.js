import { Button, Col, Collapse, Descriptions, Input, Layout, Modal, PageHeader, Row, Tag, Typography } from 'antd';
...
function ProjectRequests() {
  ...
  // TODO TEMP
  const [temp] = React.useState(false);
  ...
  useEffect(() => {
    ...
    if (temp) {
      acceptRequest(selectedProjectRequest);
      declineRequest(selectedProjectRequest);
    }
        ...
        <div
                  ...
                  <Col xs={24} md={19}>
                    <Descriptions title="Project Application Details" layout="horizontal">
                      <Descriptions.Item label="Submitted By">
                        {projectRequest.project.owner.username}
                      </Descriptions.Item>
                      <Descriptions.Item label="Project Name">{projectRequest.project.name}</Descriptions.Item>
                    ...
                    <Descriptions layout="horizontal">
                      <Descriptions.Item label="Description">{projectRequest.project.description}</Descriptions.Item>
                    </Descriptions>
          ...
          {selectedProjectRequest !== null ? (
            <Modal
              ...
              <p>
                By declining the request, {selectedProjectRequest.project.owner.username} will be notified. You can add
                a comment which will be sent with the email. Can include a reason why the project request was declined.
              </p>
              <TextArea
                placeholder="Comment..."
                allowClear
