      ...
      <Content
        ...
        <Form {...formItemLayout}>
          ...
          <Form.Item
            ...
            <Input defaultValue={request.project.name} onChange={(event) => validateName(event.target.value)} />
          </Form.Item>
          {/* Project Description */}
          <Form.Item label="Project Description" style={{ marginLeft: 'auto', marginRight: 'auto', maxWidth: 450 }}>
            <TextArea defaultValue={request.project.description} onChange={(e) => setDesc(e.target.value)} />
          </Form.Item>
          ...
          <Form.Item
            ...
            <TextArea defaultValue={request.comment} onChange={(event) => setComment(event.target.value)} />
          </Form.Item>
          {/* Button Section */}
          <div style={{ width: '100%', textAlign: 'center' }}>
            ...
            <Button disabled={!validName} type="primary" onClick={(e) => handleSubmit(e)}>
              Submit Changes
            </Button>
          </div>
        </Form>
