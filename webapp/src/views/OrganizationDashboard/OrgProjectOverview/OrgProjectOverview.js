...
function OrgProjectOverview() {
  ...
  const menuAddToServer = () => {
    if (projectModules.length > 0) {
      ...
      return (
        <Popover key={'add-to-server-disabled'} content={disabledButton} title="Button Disabled" placement="left">
          <Button style={{ marginLeft: 10, marginRight: 10 }}>Add To Server</Button>
        </Popover>
      );
    }
  };
              ...
              <Card
                ...
                <div>
                  ...
                  <div style={{ verticalAlign: 'middle' }}>
                    <Text style={{ marginLeft: 16 }}>{server.title}</Text>
