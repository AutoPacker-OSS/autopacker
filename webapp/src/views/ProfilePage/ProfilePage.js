  ...
  useEffect(
    () => {
      ...
      if (debouncedSearchTerm) {
        ...
        const projectsUrl =
          process.env.REACT_APP_APPLICATION_URL + process.env.REACT_APP_API + '/projects/' + username + '/public';
                        ...
                        <Col style={{ padding: 0 }} xs={24} key={project.id}>
                          <div key={project.id}>
                            <Col style={{ padding: 0 }}>
                              ...
                              <div>
                                <Link
                                  onClick={() => sessionStorage.setItem('selectedPublicProject', project.id)}
                                  to={'/account/' + username + '/project/' + project.name}>
                                  <Text
                                    strong
                                    style={{
                                      cursor: 'pointer',
